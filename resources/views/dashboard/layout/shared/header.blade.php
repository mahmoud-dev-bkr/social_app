        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    <img src="{{ asset('dashboard/assets/img/user1-128x128.jpg') }}" class="user-image rounded-circle shadow"
                        alt="User Image" />
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-header text-bg-primary">
                        <img src="{{ asset('dashboard/assets/img/user1-128x128.jpg') }}" class="rounded-circle shadow" alt="User Image" />
                        <p>
                            {{ Auth::user()->username }}
                            <small>
                                {{ Auth::user()->email }}
